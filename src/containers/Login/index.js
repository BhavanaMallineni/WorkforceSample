...
class Login extends React.Component {
  constructor(props){
    super(props);
    this.state = {
      username : 'sandeepperkariappdev@gmail.com',
      password: 'firebase@123'
    }
  ...
  componentWillMount(){}
  componentDidMount(){
    //this.props.dispatch(loginUser("sandeepperkariappdev@gmail.com","firebase@123"));
  }
  componentWillReceiveProps(nextProps) {
      if(nextProps.user !== undefined){
         //if(!nextProps.user.disabled && nextProps.user.emailVerified && nextProps.user.registered){
         if(!nextProps.user.disabled ){
